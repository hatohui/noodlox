...
import HoverCard from "@/components/landingpage/HoverCard";

const Page = () => {
  const router = useRouter();
  return (
    <>
      <div className="flex flex-col relative items-center justify-center gap-10  h-dvh w-dvw overflow-hidden py-[15rem] sm:py-16 lg:py-28">
        <HoverCard
          id="zag"
